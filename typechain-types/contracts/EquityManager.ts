...
export interface EquityManagerInterface extends utils.Interface {
  functions: {
...
export interface EquityManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EquityManagerInterface;
  ...
  functions: {
    ...
    timeAtLaunch(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    timeAtLaunch(overrides?: CallOverrides): Promise<PopulatedTransaction>;
